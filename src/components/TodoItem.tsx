...
export default function TodoItem({todo}:Props) {
  ...
  return (
    <div 
    className={`${todo.done ? "bg-gray-800": "bg-gray-950"} p-2.5 rounded-xl flex justify-between gap-2 items-center w-full`}>
        ...
        <div className="flex flex-col gap-2">
            ...
            <button className="bg-amber-600 hover:bg-amber-500 text-white font-semibold py-2 px-4 cursor-pointer">Edit</button>
        </div>
    </div>
  )
}
